...
function getGraspInformation(all_in_contact, contactsInfo, object_tree, 
    ...
    local mass, inertia, com = simGetShapeMassAndInertia(h_object, frame_world2work)
    ...
    names = table.copy(names, 
		...
		{'mass_workspace_wrt_world', 1},
		{'inertia_workspace_wrt_world', #inertia},
		{'com_workspace_wrt_world', #com},
